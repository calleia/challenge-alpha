...
final class PackageSearchService: PackageSearchServiceProtocol {
    ...
    func search(in location: String, completion: @escaping (Result<PackageServiceResponse, PackageServiceError>) -> Void) {
        ...
        self.httpClient.request(url: url) { result in
            ...
            case .success(let data):
                guard let response: PackageServiceResponse = try? JSONDecoder().decode(PackageServiceResponse.self, from: data) else {
...
extension PackageSearchService {
    ...
    private func makeUrl(with query: String) -> URL {
        ...
        urlComponents.queryItems = [
            ...
            URLQueryItem(name: "filters", value: "is_offer|1"),
